...
<<config_w_ani,eval=TRUE, fig.show='animate',echo=FALSE,out.width='6in',fig.cap="Embedded Point Pairs ($\\hat{X}_6$ and $\\hat{X}_7$) for all initial configurations for different $w$ values">>=
for (w.it in w.vals){
